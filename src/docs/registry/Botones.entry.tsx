...
export const botonesEntry: ComponentEntry =   {
    ...
    colors: [
      ...
      { name: "Azul Fonasa", value: "#0572CE", usage: "Fondo BotonPrimario / texto BotonLink" },
      { name: "blue-700", value: "#1d4ed8", usage: "Fondo hover BotonPrimario / hover BotonLink" },
      { name: "gray-400", value: "#9ca3af", usage: "Fondo BotonSecundario" },
      { name: "gray-500", value: "#6b7280", usage: "Fondo hover BotonSecundario" },
      { name: "gray-300", value: "#d1d5db", usage: "Fondo deshabilitados / borde BotonOutline" },
      { name: "gray-700", value: "#374151", usage: "Texto BotonOutline" },
      { name: "white", value: "#ffffff", usage: "Texto botones con fondo" },
    ],
