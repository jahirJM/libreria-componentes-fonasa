...
export const contadorEstadisticaEntry: ComponentEntry = {
  ...
  code: contadorCode,
  colors: [
    { name: "white", value: "#ffffff", usage: "Fondo de todas las variantes" },
    { name: "gray-100", value: "#f3f4f6", usage: "Acento variante neutral" },
    { name: "gray-900", value: "#111827", usage: "Número variante neutral" },
    { name: "blue-50", value: "#eff6ff", usage: "Acento variante primario" },
    { name: "Primary (Celeste)", value: "#0572CE", usage: "Número e ícono variante primario" },
    { name: "green-50", value: "#f0fdf4", usage: "Acento variante éxito" },
    { name: "green-600", value: "#16a34a", usage: "Ícono variante éxito" },
    { name: "green-700", value: "#15803d", usage: "Número variante éxito" },
    { name: "amber-50", value: "#fffbeb", usage: "Acento variante advertencia" },
    { name: "amber-500", value: "#f59e0b", usage: "Ícono variante advertencia" },
    { name: "amber-600", value: "#d97706", usage: "Número variante advertencia" },
    { name: "red-50", value: "#fef2f2", usage: "Acento variante peligro" },
    { name: "red-500", value: "#ef4444", usage: "Ícono variante peligro" },
    { name: "red-600", value: "#dc2626", usage: "Número variante peligro" },
  ],
