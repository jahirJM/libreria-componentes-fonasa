...
interface SelectBuscableProps {
  ...
  colors: [
    ...
    { name: "Fondo (cards)", value: "#f3f4f6", usage: "Fondo hover de opciones" },
    { name: "Bordes (suaves)", value: "#e5e7eb", usage: "Fondo trigger deshabilitado, hover botón limpiar" },
    { name: "Bordes (dividers)", value: "#d1d5db", usage: "Borde del trigger" },
    { name: "Texto (placeholder)", value: "#9ca3af", usage: "Texto placeholder, íconos chevron y búsqueda" },
    { name: "Texto (medio)", value: "#4b5563", usage: "Hover botón limpiar texto" },
    { name: "Texto (fondos claros)", value: "#374151", usage: "Texto de la opción seleccionada y opciones normales" },
    { name: "Color primario (fonasa)", value: "#0572CE", usage: "Ring y borde en focus del trigger" },
    { name: "Fondo badge revisión", value: "#eff6ff", usage: "Fondo opción actualmente seleccionada" },
    { name: "Texto badge revisión", value: "#1d4ed8", usage: "Texto opción actualmente seleccionada" },
    { name: "Bordes error, íconos", value: "#ef4444", usage: "Borde y ring en estado error" },
    { name: "Botón eliminar", value: "#dc2626", usage: "Texto e ícono de opciones deshabilitadas" },
  ],
  variants: [
    {
      label: "Default",
